...
//injectiing tempratures store created by provider. Now no need to pass as props

const App = inject("tempratures")(
  observer(({ tempratures }) => (
    <ul>
      <TempratureInputs />
      {tempratures.map(t => (
...
//injectiing tempratures store created by provider
@inject("tempratures")
@observer
...
ReactDOM.render(
  //creating a provider with name temprature that constins our observable temps.
  <Provider tempratures={temps}>
    <App />
  </Provider>,
